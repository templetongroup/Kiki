...
const downloadUrl =
  'https://github.com/templetongroup/Kiki/releases/download/v0.6.57/Kiki-0.6.57-macOS.zip';
    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <p className="compatibility">Version 0.6.57 · macOS 14+ · Apple silicon</p>
        </div>
      ...
      <section className="download-section" id="download">
        ...
        <div className="download-copy">
          ...
          <a className="primary-button download-button" href={downloadUrl}>
            Download Kiki 0.6.57 <span className="button-arrow" aria-hidden="true">↘</span>
          </a>

...
const downloadUrl =
  'https://github.com/templetongroup/Kiki/releases/download/v0.6.65/Kiki-0.6.65-macOS.zip';
    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <p className="compatibility">Version 0.6.65 · macOS 14+ · Apple silicon · Light &amp; dark modes</p>
        </div>
      ...
      <section className="download-section" id="download">
        ...
        <div className="download-copy">
          ...
          <a className="primary-button download-button" href={downloadUrl}>
            Download Kiki 0.6.65 <span className="button-arrow" aria-hidden="true">↘</span>
          </a>

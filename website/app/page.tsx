...
const downloadUrl =
  'https://github.com/templetongroup/Kiki/releases/download/v0.6.68/Kiki-0.6.68-macOS.zip';
      ...
      <section className="download-section" id="download">
        ...
        <div className="download-copy">
          ...
          <a className="primary-button download-button" href={downloadUrl}>
            Download Kiki 0.6.68 <span className="button-arrow" aria-hidden="true">↘</span>
          </a>

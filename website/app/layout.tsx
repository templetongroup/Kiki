...
export const metadata: Metadata = {
  ...
  description: 'Dictate anywhere, capture meetings, and transcribe recordings. Kiki runs fully locally on your Mac.',
  openGraph: {
    title: 'Kiki | Private voice intelligence for Mac',
    description: 'Dictate, capture meetings, and transcribe recordings without sending a word off your Mac.',

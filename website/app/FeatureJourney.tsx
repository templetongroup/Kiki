...
const features = [
  {
    ...
    image: '/product/kiki-transcripts.png',
    alt: 'Kiki Transcripts with recording and audio import',
  },
  {
    id: 'meetings',
    label: 'Meetings',
    title: 'Capture the room. Keep it private.',
    copy: 'Record your microphone and Mac audio on separate tracks, then edit, copy, or export the transcript.',
    proof: 'Export Markdown, text, SRT, or WebVTT without uploading the meeting.',
    image: '/product/kiki-meeting.png',
    alt: 'Kiki recording microphone and Mac audio locally',
  },
  {
    id: 'recordings',
    label: 'Recordings',
